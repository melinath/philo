...
# <root>/lib/extjs
$ext_path = "static/gilbert/extjs"

# sass_path: the directory your Sass files are in. THIS file should also be in the Sass folder
# Generally this will be in a resources/sass folder
# <root>/resources/sass
sass_path = File.join(file_dir, "sass")

# css_path: the directory you want your CSS files to be.
# Generally this is a folder in the parent directory of your Sass files
# <root>/resources/css
css_path = File.join(file_dir, "static", "gilbert", "murano")
...
# We need to load in the Ext4 themes folder, which includes all its default styling, images, variables and mixins
