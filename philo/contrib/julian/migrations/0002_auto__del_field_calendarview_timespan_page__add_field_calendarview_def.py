...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CalendarView.timespan_page'
        db.delete_column('julian_calendarview', 'timespan_page_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CalendarView.timespan_page'
        db.add_column('julian_calendarview', 'timespan_page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='calendar_timespan_related', null=True, to=orm['philo.Page'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'julian.calendarview': {
            ...
            'default_duration': ('django.db.models.fields.PositiveIntegerField', [], {'default': '7', 'max_length': '5'}),
