...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormView.name'
        db.add_column('bartleby_formview', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'FormView.name'
        db.delete_column('bartleby_formview', 'name')
