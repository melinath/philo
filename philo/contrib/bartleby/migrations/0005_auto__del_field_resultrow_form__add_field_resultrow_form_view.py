...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResultRow.form'
        db.delete_column('bartleby_resultrow', 'form_id')

        # Adding field 'ResultRow.form_view'
        db.add_column('bartleby_resultrow', 'form_view', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='result_rows', to=orm['bartleby.FormView']), keep_default=False)

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ResultRow.form'
        raise RuntimeError("Cannot reverse this migration. 'ResultRow.form' and its values cannot be restored.")

        # Deleting field 'ResultRow.form_view'
        db.delete_column('bartleby_resultrow', 'form_view_id')
    ...
    models = {
        ...
        'bartleby.formview': {
            ...
            'results_email_sender': ('django.db.models.fields.CharField', [], {'default': "u'noreply@127.0.0.1:8000'", 'max_length': '200', 'blank': 'True'}),
