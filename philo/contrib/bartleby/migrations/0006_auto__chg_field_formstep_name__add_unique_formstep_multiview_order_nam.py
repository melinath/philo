...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormStep.name'
        db.alter_column('bartleby_formstep', 'name', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Adding index on 'FormStep', fields ['name']
        db.create_index('bartleby_formstep', ['name'])

        # Adding unique constraint on 'FormStep', fields ['multiview', 'order', 'name']
        db.create_unique('bartleby_formstep', ['multiview_id', 'order', 'name'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'FormStep', fields ['multiview', 'order', 'name']
        db.delete_unique('bartleby_formstep', ['multiview_id', 'order', 'name'])

        # Removing index on 'FormStep', fields ['name']
        db.delete_index('bartleby_formstep', ['name'])

        # Changing field 'FormStep.name'
        db.alter_column('bartleby_formstep', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
