...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Form.key'
        db.delete_column('bartleby_form', 'key')

        # Changing field 'Field.label'
        db.alter_column('bartleby_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Field.key'
        db.alter_column('bartleby_field', 'key', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Field.help_text'
        db.alter_column('bartleby_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Form.key'
        raise RuntimeError("Cannot reverse this migration. 'Form.key' and its values cannot be restored.")

        # Changing field 'Field.label'
        db.alter_column('bartleby_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Field.key'
        db.alter_column('bartleby_field', 'key', self.gf('django.db.models.fields.SlugField')(max_length=100))

        # Changing field 'Field.help_text'
        db.alter_column('bartleby_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'bartleby.formstep': {
            'Meta': {'ordering': "('order',)", 'unique_together': "(('form', 'multiview'), ('order', 'name', 'multiview'))", 'object_name': 'FormStep'},
        ...
        'bartleby.resultrow': {
            ...
            'form_view': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'result_rows'", 'to': "orm['bartleby.FormView']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
